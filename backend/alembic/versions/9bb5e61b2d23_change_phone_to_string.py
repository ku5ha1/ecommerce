"""change_phone_to_string

Revision ID: 9bb5e61b2d23
Revises: d01774d113c9
Create Date: 2025-07-12 19:04:05.331603
...
revision: str = '9bb5e61b2d23'
down_revision: Union[str, Sequence[str], None] = 'd01774d113c9'
...
def downgrade() -> None:
    ...
    sa.Column('delivery_method', sa.VARCHAR(length=8), server_default=sa.text("'delivery'::character varying"), autoincrement=False, nullable=False),
